...
namespace SmashBros
{
	SCRIPTEDCLASS_CONSTRUCTOR_HEADER(Player, x1 _COMMA y1 _COMMA playerNo _COMMA team, float x1, float y1, byte playerNo, byte team)
	{
		SCRIPTEDCLASS_CONSTRUCTOR_BODY(
			ScriptManager::module_GameEngine,
			ScriptManager::module_SmashBros,
			ScriptManager::module_GameEngine_Actor_protected,
			ScriptManager::module_SmashBros_GameElement_protected,
			ScriptManager::module_SmashBros_Player_protected)
