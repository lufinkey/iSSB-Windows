...
namespace GameEngine
{
	...
	Actor::Actor(const Actor& actor)
	{
		...
		wireframeColor = sf::Color(actor.wireframeColor);
	...
	void Actor::onAnimationFinish(const String&name) //inherited user-defined method. is called when an animation ends and String is name of animation
	{
