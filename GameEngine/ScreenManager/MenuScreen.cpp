...
{
	MenuScreen::MenuScreen(const String&n) : Screen(n)
	{
		selectedIndex = -1;
	...
	{
		Items.add(new MenuItem(new ImageMenuItem(this, x1,y1,normAnim,hoverAnim,target)));
	}

	void MenuScreen::addItem(float x1, float y1,Animation*normAnim, Animation*hoverAnim, Animation*clickAnim, const String&target)
	{
		Items.add(new MenuItem(new ImageMenuItem(this, x1,y1,normAnim,hoverAnim,clickAnim,target)));
	}

	void MenuScreen::addItem(float x1, float y1,Animation*anim, const Color&hoverColor, const String&target)
	{
		Items.add(new MenuItem(new ImageMenuItem(this, x1,y1,anim,hoverColor,target)));
	}
	...
	void MenuScreen::addItem(float x1, float y1,const String&normAnim,const String&hoverAnim,const String&clickAnim, const String&target)
	{
		...
		Items.add(new MenuItem(new ImageMenuItem(this, x1,y1,norm,hover,click,target)));
	}
	...
	void MenuScreen::addItem(float x1, float y1,const String&anim, const Color&hoverColor, const String&target)
	{
		Animation*norm = new Animation("normal",1);
		norm->addFrame(anim);
		Items.add(new MenuItem(new ImageMenuItem(this, x1,y1,norm,hoverColor,target)));
	}
	...
	void MenuScreen::addItem(float x1, float y1,const String&anim, const Color&hoverColor, const Color&clickColor, const String&target)
	{
		Animation*norm = new Animation("normal",1);
		norm->addFrame(anim);
		Items.add(new MenuItem(new ImageMenuItem(this, x1,y1,norm,hoverColor,clickColor,target)));
	}
	...
	{
		Items.add(new MenuItem(new TextMenuItem(this, x1, y1, s,f,normC,hoverC,target)));
	}
	...
	{
		Items.add(new MenuItem(new TextMenuItem(this, x1, y1, s,f,normC,hoverC,clickC,target)));
	}
	...
	MenuScreen::MenuItem::MenuItem(TextMenuItem*textItem)
	{
		this->itemType = TEXT;
		this->textItem = textItem;
	}

	MenuScreen::MenuItem::MenuItem(ImageMenuItem*imageItem)
	{
		this->itemType = IMAGE;
