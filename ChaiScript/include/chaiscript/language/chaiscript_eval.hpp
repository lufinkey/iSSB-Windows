    ...
    struct Method_AST_Node : public AST_Node {
      public:
        ...
        virtual Boxed_Value eval_internal(chaiscript::detail::Dispatch_Engine &t_ss) CHAISCRIPT_OVERRIDE{
          ...
          if ((this->children.size() > (unsigned int)(3 + class_offset)) && (this->children[(2 + class_offset)]->identifier == AST_Node_Type::Arg_List)) {
			...
			if (this->children.size() >(unsigned int)(4 + class_offset)) {
			...
			if (this->children.size() > (unsigned int)(3 + class_offset)) {
